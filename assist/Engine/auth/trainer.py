...
path = 'assist\\Engine\\auth\\samples' # Path for samples already taken
...
recognizer.write('assist\\Engine\\auth\\trainer\\trainer.yml')  # Save the trained model as trainer.yml
